...
//----------------------------------( LLAMADAS )-------------------------------------------------
//-----------------------------------------------------------------------------------------------------------------
asignar_valor("wl_baprobar","Modificar Alarma");
asignar_valor("wl_baprobar1","Modificar Alarma");
...
{	if(obtener_valor("ORIGEVENTO")=="")
	...
	{	MostrarCampo("ORIGEVENTO");
		...
		{	MostrarCampo('M_ARCH',3,3);
			...
			asignar_valor("ACCESO_VIR",dir_vir+obtener_valor('IGNUDOC')+"."+obtener_valor('EXT'));
		}
	}
	return true;
}
...
asignar_event("onclick" ,"obligatoriedad()" , "wl_baprobar");
asignar_event("onclick" ,"obligatoriedad()" , "wl_baprobar1");
/******************************************************/
