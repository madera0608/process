	...
	if(obtener_valor('DELEGA_A') == 'NO' && obtener_valor('CLAS_COMUN') != 4){
		...
		if(obtener_valor('ENV_RESP') == ''){
			...
			return false;
       	               ...
       	               if(obtener_valor( 'ORGANISMO' ) == 1 && obtener_valor( 'OTRO_OG' ) == ''){
			alertmb("Campo Otro Organismo no puede estar vacío.",2,1,"Aceptar");
			return false;
		}
...
if (obtener_valor("INSUB")=="0"  &&  obtener_valor( 'CLAS_COMUN' ) != 4)
   OcultarCampo( 'DELEGA_A' );
