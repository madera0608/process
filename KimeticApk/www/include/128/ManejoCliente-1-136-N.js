...
asignar_event( "onclick" , "ValidarUserIMSS();ValidarCheckNomina();ValidaEnvio()", "wl_baprobar" );
asignar_event( "onclick" , "ValidarUserIMSS();ValidarCheckNomina();ValidaEnvio()", "wl_baprobar1" );
