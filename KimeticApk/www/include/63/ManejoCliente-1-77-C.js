...
var filas = obtener_valor("filINFADICD");

   if (filas>=3) 
      {
document.getElementById("MATNVINFADICD").disabled=true;

      }
else{

document.getElementById("MATNVINFADICD").disabled=false;
}
...
asignar_event("onclick" ,"DetenerMatriz()", "MATNVINFADICD");
