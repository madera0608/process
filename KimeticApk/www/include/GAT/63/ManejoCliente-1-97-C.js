...
asignar_valorM( "INFINDVD", obtener_valorM( "INFADICD" , 1 , 1) , 1 , 1);
asignar_valorM( "INFINDVD", obtener_valorM( "INFADICD" , 1 , 2) , 1 , 2);
asignar_valorM( "INFINDVD", obtener_valorM( "INFADICD" , 1 , 3) , 1 , 3);
asignar_valorM( "INFINDVD", obtener_valorM( "INFADICD" , 1 , 4) , 1 , 4);
asignar_valorM( "INFINDVD", obtener_valorM( "INFADICD" , 1 , 5) , 1 , 5);
asignar_valorM( "INFINDVD", obtener_valorM( "INFADICD" , 1 , 6) , 1 , 6);
asignar_valorM( "INFINDVD", obtener_valorM( "INFADICD" , 1 , 7) , 1 , 7);
asignar_valorM( "INFINDVD", obtener_valorM( "INFADICD" , 1 , 8) , 1 , 8);
