...
asignar_valorM( "INFOINDV", obtener_valorM( "INFOADIC" , 2 , 1) , 1 , 1);
asignar_valorM( "INFOINDV", obtener_valorM( "INFOADIC" , 2 , 2) , 1 , 2);
asignar_valorM( "INFOINDV", obtener_valorM( "INFOADIC" , 2 , 3) , 1 , 3);
asignar_valorM( "INFOINDV", obtener_valorM( "INFOADIC" , 2 , 4) , 1 , 4);
asignar_valorM( "INFOINDV", obtener_valorM( "INFOADIC" , 2 , 5) , 1 , 5);
asignar_valorM( "INFOINDV", obtener_valorM( "INFOADIC" , 2 , 6) , 1 , 6);
asignar_valorM( "INFOINDV", obtener_valorM( "INFOADIC" , 2 , 7) , 1 , 7);
asignar_valorM( "INFOINDV", obtener_valorM( "INFOADIC" , 2 , 8) , 1 , 8);
/******************************************************/
