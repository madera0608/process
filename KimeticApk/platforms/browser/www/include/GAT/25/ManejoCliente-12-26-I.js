...
function formatear(){
	...
	asignar_valor('NB_CLASE1',obtener_valor("CLASE1",2));
...
function ocultar(){
	if(obtener_valor("CLASE1",2)=="(Nueva Clasificación)"){
...
function consulta(){
	var opcion = alertmb("Está apunto de registrar un nuevo parámetro a esta clasificación. ¿Está usted de acuerdo?",1,2,"Cancelar","Continuar");
