...
{
  var verif = obtener_valor(matriz,get_fila(matriz),columna); 
  var tam= obtener_valor("fil"+matriz)+0;
   for (var i =1; i <=tam ;i++) 
     if (verif ==obtener_valor(matriz,i,columna) )
        {
           alertmb("El Banco " + verif + " existe en la fila, no puede indicar 2 veces un mismo banco " + i, 0, 1, "Aceptar");
           asignar_valorM( matriz , "Seleccione" , i , columna );
           return false;
        }
   return true;
}
