...
asignar_valor( 'wl_bsolicitar1' , 'Migrar Usuarios');
...
{	
	...
	{
		var opcion = alertmb("Se creará un Perfil para cada usuario sin Perfil asignado, ¿Desea Continuar?",1,2,"Aceptar","Cancelar");
