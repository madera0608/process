...
asignar_valorM( "INFOINDV", obtener_valorM( "INFOADIC" , 3 , 1) , 1 , 1);
asignar_valorM( "INFOINDV", obtener_valorM( "INFOADIC" , 3 , 2) , 1 , 2);
asignar_valorM( "INFOINDV", obtener_valorM( "INFOADIC" , 3 , 3) , 1 , 3);
asignar_valorM( "INFOINDV", obtener_valorM( "INFOADIC" , 3 , 4) , 1 , 4);
asignar_valorM( "INFOINDV", obtener_valorM( "INFOADIC" , 3 , 5) , 1 , 5);
