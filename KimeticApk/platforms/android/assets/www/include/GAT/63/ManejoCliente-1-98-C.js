...
if (obtener_valor('INFREC',0)=='T')
  {
    MostrarGrupo( "REVISIÓN DEL CASO POR EL DEFENSOR" );  
    MostrarGrupo( "generar respuesta del defensor" ); 
  }
if (obtener_valor('INFREC',1)=='T')
  {
    OcultarGrupo( "REVISIÓN DEL CASO POR EL DEFENSOR" );  
    OcultarGrupo( "generar respuesta del defensor" ); 
  }
if (obtener_valor('INFREC',0)!='T' && obtener_valor('INFREC',1)!='T' )
  {
    OcultarGrupo( "REVISIÓN DEL CASO POR EL DEFENSOR" ); 
     OcultarGrupo( "generar respuesta del defensor" );  
  }
...
asignar_event("onclick" , "FINANALISIS()" ,"INFREC");
...
function ValidaBUS()
{
  if (obtener_valorM('RESP_DEF',1,1)=='' && obtener_valor('INFREC',0)=='T')   
  {
...
{
  if (obtener_valor('INDIDEF')!='X' && obtener_valor('INFREC',0)=='T')     
  {
