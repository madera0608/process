...
if (obtener_valor('WKPP')=='560'){

OcultarGrupo( 'DATOS DEL CONTRATO' );
OcultarGrupo( 'DETALLE DE NOMINA(S)' );
MostrarGrupo( 'DATOS DEL USO DE PROVISIÓN' );
OcultarCampo( 'MONTPREF' );
OcultarCampo( 'CODFACT' );
	OcultarCampo( 'FCHDIS' );
	OcultarCampo( 'FCHEFEC' );
}else{
MostrarGrupo( 'DATOS DEL CONTRATO' );
MostrarGrupo( 'DETALLE DE NOMINA(S)' );
OcultarGrupo( 'DATOS DEL USO DE PROVISIÓN' );
MostrarCampo( 'MONTPREF' );
MostrarCampo( 'CODFACT' );
	MostrarCampo( 'FCHDIS' );
	MostrarCampo( 'FCHEFEC' );
}

if (obtener_valor( "TPOSOL" )=='Pago a tercero')
  {
    OcultarGrupo( "DETALLE DE NOMINA(S)" );
    OcultarGrupo( "DATOS DEL CONTRATO");
  }
...
//document.getElementById("wl_bobjetar").style.display="none"
//document.getElementById("wl_bobjetar1").style.display="none"
